...
from sklearn.tree import DecisionTreeClassifier, export_graphviz  # Classe para criar árvore de decisão e função para visualização
...
import graphviz  # Biblioteca para visualização gráfica
...
dot_data = export_graphviz(modelo,
                           ...
                           filled=True,
                           feature_names=csv_data.drop(
                               columns=['work_setting','salary_currency','salary','job_title', 'work_year']).columns,
                           class_names=True,
                           rounded=True)

#Defina o caminho completo para o executável 'dot' no seu ambiente virtual
graphviz.backend.ExecutableNotFound._executable = "/caminho/para/o/executavel/dot"  # Substitua pelo caminho correto
